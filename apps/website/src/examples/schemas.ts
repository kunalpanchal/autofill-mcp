import type { JsonSchema, JsonValue } from "@kunalpanchal/formsync-core";
...
export const productHuntSchema: JsonSchema = {
  ...
  properties: {
    ...
    repoUrl: { type: "string", format: "uri", description: "Public GitHub or GitLab link" },
...
export const exampleFillers = {
  productHunt: (): Record<string, JsonValue> => ({
    projectName: "FormSync",
    tagline: "Local AI that fills web forms",
    description:
      "FormSync lets a site add one Fill with AI button. Your assistant reads a JSON Schema, pulls context from local files, and returns structured values. It never gets the DOM or browser control.",
