...
import { exampleFillers, githubRepoSchema } from "../../examples/schemas.js";

export function GitHubExample() {
  const [log, setLog] = useState("Waiting for Fill with AI...");
  return (
    <article>
      <p className="kicker">Example · selects, radios, checkboxes</p>
      <h1>Create a GitHub repository</h1>
      <p className="lede">
        FormSync writes native values and dispatches input/change so React state stays in sync.
      </p>
      <form id="github-form" className="card" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="form-actions">
          <FormSyncButton
            ...
            transports={["mock"]}
            mockFiller={exampleFillers.github}
